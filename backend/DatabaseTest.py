...
def isHigher(scrLat, srcLon, destLat, destLon, distance, results):
    ...
    mc.execute(
        "INSERT INTO request(srcLat, srcLon, destLat, destLon, date, time, distance) VALUES(%s,%s,%s,%s,%s,%s,%s)",
        (scrLat, srcLon, destLat, destLon, date, now, distance))
    ...
    for result in results:
        ...
        mc.execute("INSERT INTO ride(name, price, seats, shared, pickup, arrival) VALUES(%s,%s,%s,%s,%s,%s)",
                   (name, price, seats, shared, pickup.time(), arrival.time()))
...
def check():
    mc.execute(
        "SELECT * FROM request JOIN generates ON request.reqid = generates.reqid JOIN ride ON ride.rid = generates.rid")
    for x in mc:
        print(x)
...
def calcAVG(distance):
    ...
    mc.execute(
        "SELECT AVG(price) FROM ride JOIN generates ON ride.rid = generates.rid JOIN request ON request.reqid = generates.reqid, distances WHERE request.distance BETWEEN distances.lower AND distances.upper")
...
def testFalse():
    clearTables()
    dicList = [{'name': "UberXL", 'price': 32.12, 'seats': 3, 'shared': 0, 'pickup': '2007-03-04T21:08:12',
                'arrival': '2007-03-04T21:08:12'},
               {'name': "UberX", 'price': 21.51, 'seats': 3, 'shared': 1, 'pickup': '2007-03-04T15:28:16',
                'arrival': '2007-03-04T21:08:12'},
               {"name": "Uber Pool", "price": 54.68, "seats": 2, "shared": 0, "pickup": '2007-03-04T01:08:12',
                "arrival": '2007-03-04T21:08:12'},
               {"name": "Uber Comfort", "price": 56.25, "seats": 1, "shared": 0, "pickup": '2007-03-04T21:08:12',
                "arrival": '2007-03-04T21:08:12'}]
    dicList2 = [{'name': "UberXL", 'price': 42.12, 'seats': 3, 'shared': 0, 'pickup': '2007-03-04T21:08:12',
                 'arrival': '2007-03-04T21:08:12'},
                {'name': "UberX", 'price': 31.51, 'seats': 3, 'shared': 1, 'pickup': '2007-03-04T15:28:16',
                 'arrival': '2007-03-04T21:08:12'},
                {"name": "Uber Pool", "price": 54.68, "seats": 2, "shared": 0, "pickup": '2007-03-04T01:08:12',
                 "arrival": '2007-03-04T21:08:12'},
                {"name": "Uber Comfort", "price": 56.25, "seats": 1, "shared": 0, "pickup": '2007-03-04T21:08:12',
...
def testTrue():
    ...
    dicList = [{'name': "UberXL", 'price': 32.12, 'seats': 3, 'shared': 0, 'pickup': '2007-03-04T21:08:12',
               ...
               {"name": "Uber Comfort", "price": 56.25, "seats": 1, "shared": 0, "pickup": '2007-03-04T21:08:12',
                "arrival": '2007-03-04T21:08:12'}]
    dicList2 = [{'name': "UberXL", 'price': 82.12, 'seats': 3, 'shared': 0, 'pickup': '2007-03-04T21:08:12',
                 'arrival': '2007-03-04T21:08:12'},
                {'name': "UberX", 'price': 51.51, 'seats': 3, 'shared': 1, 'pickup': '2007-03-04T15:28:16',
                 'arrival': '2007-03-04T21:08:12'},
                {"name": "Uber Pool", "price": 74.68, "seats": 2, "shared": 0, "pickup": '2007-03-04T01:08:12',
                 "arrival": '2007-03-04T21:08:12'},
                {"name": "Uber Comfort", "price": 156.25, "seats": 1, "shared": 0, "pickup": '2007-03-04T21:08:12',
                 "arrival": '2007-03-04T21:08:12'}]
    isHigher(100.231, 243.21, 200.451, 354.213, 15.23, dicList)
    print("OUTCOME: "),
